...
class ArticleTest < ActiveSupport::TestCase
  ...
  # no_expiratonがオンならexpired_atを使わない
  ...
  test "open" do
    ...
    article2 = FactoryGirl.create(:article, title: "過去", released_at: 2.day.ago, expired_at: 1.day.ago)
    article3 = FactoryGirl.create(:article, title: "未来", released_at: 1.day.from_now, expired_at: 2.day.from_now)
